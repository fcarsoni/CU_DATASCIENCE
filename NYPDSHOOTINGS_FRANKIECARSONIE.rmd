...
and added a column in the nypd shootings data for the hour that a shooting occured
```{r get hourly data}
nypdshootings <- nypdshootings %>%
...
I then used this hourly data to create a bar chart that showed the hours that shootings occured most, clearly in the evening between 6 pm and 5 am
```{r bar charts}
...
I created a bar chart for the daily and monthly shootings and a line chart or the yearly shooting information
